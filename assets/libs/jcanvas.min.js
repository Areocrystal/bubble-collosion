...
!function (a, b, c) {
    ...
    function A(a, b, c) {
        ...
        if (g = b.drag, e = g.layer, h = e && e.dragGroups || [], d = b.layers, "mousemove" === c || "touchmove" === c) {
            if (g.dragging || (g.dragging = !0, e.dragging = !0, e.bringToFront && (d.splice(e.index, 1), e.index = d.push(e)), e._startX = e.x, e._startY = e.y, e._endX = e._eventX, e._endY = e._eventY, F(a, b, e, "dragstart")), g.dragging)for (l = e._eventX - (e._endX - e._startX), m = e._eventY - (e._endY - e._startY), e.updateDragX && (l = e.updateDragX.call(a[0], e, l)), e.updateDragY && (m = e.updateDragY.call(a[0], e, m)), e.dx = l - e.x, e.dy = m - e.y, "y" !== e.restrictDragToAxis && (e.x = l), "x" !== e.restrictDragToAxis && (e.y = m), F(a, b, e, "drag"), k = 0; k < h.length; k += 1)if (j = h[k], i = b.layer.groups[j], e.groups && i)for (f = 0; f < i.length; f += 1)i[f] !== e && ("y" !== e.restrictDragToAxis && "y" !== i[f].restrictDragToAxis && (i[f].x += e.dx), "x" !== e.restrictDragToAxis && "x" !== i[f].restrictDragToAxis && (i[f].y += e.dy))
    ...
    function J(a, b, c) {
        var d, e, f, g;
        for (d in c)if (Object.prototype.hasOwnProperty.call(c, d) && (e = c[d], ta(e) && (c[d] = e.call(a, b, d)), "object" === sa(e) && ua(e))) {
    ...
    d.baseDefaults = {
        ...
        if (0 !== g.length)if (b = g[0], c = r(b), d = c.layers, ta(a))for (f = 0; f < d.length; f += 1)e = d[f], a.call(b, e) && h.push(e); else h = d;
        return h
    }, a.fn.getLayer = function (a) {
        var b, c, d, f, g, h, i = this;
        if (0 !== i.length)if (b = i[0], c = r(b), d = c.layers, h = sa(a), a && a.layer)f = a; else if ("number" === h)a < 0 && (a = d.length + a), f = d[a]; else if ("regexp" === h) {
        ...
        for (e = 0; e < m.length; e += 1)if (d = a(m[e]), g = r(m[e]), i = a(m[e]).getLayer(b)) {
        ...
        for (d = 0; d < h.length; d += 1)c = a(h[d]), e = r(h[d]), f = c.getLayers(), (g = c.getLayer(b)) && (g.index = ra(g, f), f.splice(g.index, 1), delete g._layer, w(c, e, g, {name: null}), x(c, e, g, {groups: null}), F(c, e, g, "remove"));
        return h
        ...
        for (e = 0; e < g.length; e += 1)d = a(g[e]), f = d.getLayer(b), f.groups && (h = f.groups.slice(0), -1 === ra(c, f.groups) && h.push(c)), d.setLayer(f, {groups: h});
        return g
    }, a.fn.removeLayerFromGroup = function (b, c) {
        var d, e, f, g, h = this, i = [];
        for (e = 0; e < h.length; e += 1)d = a(h[e]), f = d.getLayer(b), f.groups && -1 !== (g = ra(c, f.groups)) && (i = f.groups.slice(0), i.splice(g, 1), d.setLayer(f, {groups: i}));
        return h
        ...
        for (l = t.index, l || (l = 0), d = 0; d < s.length; d += 1)if (c = a(s[d]), e = g(s[d])) {
            for (n = r(s[d]), !1 !== t.clear && c.clearCanvas(), f = n.layers, k = l; k < f.length; k += 1)if (h = f[k], h.index = k, t.resetFire && (h._fired = !1), z(c, e, h, k + 1), h._masks = n.transforms.masks.slice(0), h._method === a.fn.drawImage && h.visible) {
                q = !0;
                break
            }
            if (q)break;
        ...
        if (Da.drawings[h.type] && "function" !== h.type)f[Da.drawings[h.type]](b); else for (d = 0; d < f.length; d += 1)(e = g(f[d])) && (h = new c(b), G(f[d], h, b, a), h.visible && h.fn && h.fn.call(f[d], e, h));
        return f
        ...
        for (d = 0; d < k.length; d += 1)if (e = g(k[d]))for (h = r(k[d]), f = new c(b), G(k[d], f, b, a), i = 0; i < f.count; i += 1)j(e, h);
        return k
    }, a.fn.restoreCanvas = function a(b) {
        var d, e, f, h, i, j = this;
        for (d = 0; d < j.length; d += 1)if (e = g(j[d]))for (h = r(j[d]), f = new c(b), G(j[d], f, b, a), i = 0; i < f.count; i += 1)k(e, h);
        return j
        ...
        for (d = 0; d < r.length; d += 1)if ((e = g(r[d])) && (f = new c(b), G(r[d], f, b, a), f.visible)) {
        ...
        var d, e, f, h, i, j = this;
        for (d = 0; d < j.length; d += 1)if ((e = g(j[d])) && (f = new c(b), G(j[d], f, b, a), f.visible)) {
        ...
        for (d = 0; d < v.length; d += 1)if ((e = g(v[d])) && (f = new c(b), G(v[d], f, b, a), f.visible)) {
            if (e.textBaseline = f.baseline, e.textAlign = f.align, fa(v[d], e, f), i = null !== f.maxWidth ? ha(e, f) : f.text.toString().split("\n"), ga(v[d], e, f, i), h && (h.width = f.width, h.height = f.height), q(v[d], e, f, f.width, f.height), m(v[d], e, f), t = f.x, "left" === f.align ? f.respectAlign ? f.x += f.width / 2 : t -= f.width / 2 : "right" === f.align && (f.respectAlign ? f.x -= f.width / 2 : t += f.width / 2), f.radius)for (l = pa(f.fontSize), null === f.letterSpacing && (f.letterSpacing = l / 500), k = 0; k < i.length; k += 1) {
        ...
        var b, d, e, f = this;
        return d = f.getLayer(a), (!d || d && !d._layer) && (d = new c(a)), b = g(f[0]), b && (fa(f[0], b, d), e = ha(b, d), ga(f[0], b, d, e)), d
        ...
        return e = g(l[0]), e ? (f = new c(b), k = f.source, ta(k) ? (h = a("<canvas />")[0], h.width = f.width, h.height = f.height, i = g(h),
            k.call(h, i), d()) : (i = k.getContext, k.src || i ? h = k : (h = new ka, k.match(/^data:/i) || (h.crossOrigin = f.crossOrigin), h.src = k), h.complete || i ? d() : (h.onload = d, h.src = h.src))) : j = null, j
        ...
        for (e = 0; e < o.length; e += 1)if (d = o[e], f = g(d), h = r(o[e]), f && (i = new c(b), G(d, i, b, a), q(o[e], f, i, i.width, i.height), null !== i.width && null !== i.height || (i.width = d.width, i.height = d.height, i.x = i.width / 2, i.y = i.height / 2), 0 !== i.width && 0 !== i.height)) {
            if (k = f.getImageData((i.x - i.width / 2) * h.pixelRatio, (i.y - i.height / 2) * h.pixelRatio, i.width * h.pixelRatio, i.height * h.pixelRatio), l = k.data, n = l.length, i.each)for (m = 0; m < n; m += 4)j = {
                r: l[m],
                g: l[m + 1],
                b: l[m + 2],
                a: l[m + 3]
